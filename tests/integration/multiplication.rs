...
fn Mat2x2_mul_Mat2x3() {
  use h::*;
  let red = mat2x2_row(1.0, 2.0, 3.0, 4.0);
  let yellow = mat2x3_row(2.0, 0.0, 1.0, 2.0, -1.0, -3.0);
  assert_eq!(red * yellow, mat2x3_row(6.0, -2.0, -5.0, 14.0, -4.0, -9.0));
}
...
fn Mat2x2_mul_Mat2x4() {
  use h::*;
  let red = mat2x2_row(1.0, 2.0, 3.0, 4.0);
  let yellow = mat2x4_row(2.0, 0.0, 1.0, 2.0, -1.0, -3.0, 1.0, 2.0);
  assert_eq!(red * yellow, mat2x4_row(0.0, -6.0, 3.0, 6.0, 2.0, -12.0, 7.0, 14.0));
}
